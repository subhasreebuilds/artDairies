    ...
    <div className="min-h-screen bg-ivory text-ink-900">
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          {/* Image Side */}
          <div className="relative w-full aspect-[3/4] bg-earth-200">
          ...
          <div className="flex flex-col justify-center h-full">
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl mb-12">
              The Artist <br/>
              <span className="text-accent-gold italic font-light text-4xl md:text-5xl lg:text-6xl">Behind the Diaries</span>
            </h1>

            <div className="space-y-8 font-light leading-relaxed text-ink-800 text-lg">
              <p>
            ...
            <div className="mt-16 pt-12 border-t border-ink-900/10">
              <h2 className="font-serif text-2xl mb-6">Exhibitions & Features</h2>
              <ul className="space-y-4 font-light text-ink-800">
                <li>[PLACEHOLDER: 2024 - Name of Exhibition / Feature]</li>
                <li>[PLACEHOLDER: 2023 - Name of Exhibition / Feature]</li>
                <li>[PLACEHOLDER: 2022 - Name of Exhibition / Feature]</li>
              </ul>
            </div>
            ...
            <div className="mt-16">
              <Link 
                href="/contact"
                className="inline-block border border-ink-900 text-ink-900 hover:bg-ink-900 hover:text-ivory px-8 py-4 uppercase tracking-widest text-sm transition-colors"
              >
                Get in Touch
              </Link>
            </div>
