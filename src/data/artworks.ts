...
export const artworks: Artwork[] = [
  ...
  },
  {
    ...
    description: "A meticulously crafted dot mandala symbolizing peace, unity, and spiritual centering.",
  ...
  },
  {
    ...
    description: "A complex, geometric pen and ink drawing that draws the viewer into a meditative state.",
